        ...
        try:
            ...
            for p in solution_path:
                if self.G.nodes[p['path'][1]]['type'] != 'L':
                    cost += self.ftl_fix_cost(p['weight']) or 0
...
if __name__=='__main__':
    plm = graphProblem(data_path=r"D:\Development\code_commit_repo\vrp\dataset\test_data_200_nodes\data.pkl",
